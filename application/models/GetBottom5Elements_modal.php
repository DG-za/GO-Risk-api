<?php 
class GetBottom5Elements_modal extends CI_Model {
	
	/* Get Bottom 5 Elements Function */
	public function getBottom5Elements_function(){
		$this->db->select("`m_e`.`name`,sum(`m_am`.`answer`) AS `score`,count(`m_am`.`answer`) AS `count`");
