<?php 
class Get5BiggestGapsPerformance_modal extends CI_Model {
	...
	public function getAllPerformanceAnswersByElement_function($elementId) {
	...
	public function getAllPerformanceDesiredByElement_function($elementId) {
