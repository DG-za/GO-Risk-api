...
class Get5BiggestGapsPerformance_model extends CI_Model {
	...
	public function getAllPerformanceAnswersByArea_function_User($elementId,$selectedSessionId,$toUserId) {
		if($selectedSessionId != null && $selectedSessionId != "null"){
			$whereArr=array(
				"`session_id`"=>$selectedSessionId,
				"`element`"=>$elementId,
	...
	public function getAllPerformanceDesiredByArea_function_User($elementId,$selectedSessionId,$toUserId) {
		if($selectedSessionId != null && $selectedSessionId != "null"){
			$whereArr=array(
				"`session_id`"=>$selectedSessionId,
				"`element`"=>$elementId,
