...
class SaveActionsRisks extends REST_Controller {
	/***************************************************************
	*  Project Name : 4Xcellence Solutions
	*  Created By :   
	*  Created Date : 27-09-2019
	*  Description : A controller contain SaveActionsRisks related methods
	...
	***************************************************************/
	...
	public function __construct() {
		...
		$this->load->model('maturity/SaveActionsRisks_model');
	}
	...
	public function index_post(){
		...
		$message = 'Required field(s) user_id,element,risks is missing or empty';
		...
		if(isset($user_id) && isset($element) && isset($risks)){
			...
			if($token_status == TRUE){
				...
				$Replace_Risks_Result = $this->SaveActionsRisks_model->Replace_Action_Risk($Replace_Risks_Array);
