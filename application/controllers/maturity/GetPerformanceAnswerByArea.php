...
class GetPerformanceAnswerByArea extends REST_Controller {
	/***************************************************************
	...
	***************************************************************/
	...
	public function __construct() {
		...
		$this->load->model('maturity/GetPerformanceAnswerByArea_model');
	}
		...
		if(isset($user_id) && isset($Element_ID)){
			...
			if($token_status == TRUE){
				...
				if(!empty($All_Performance_Answer)){
					...
					$All_Performance_Quetion_ID = $this->GetPerformanceAnswerByArea_model->Get_Performance_Quetion_ID();
