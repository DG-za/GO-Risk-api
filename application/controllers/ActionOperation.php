...
class ActionOperation extends REST_Controller {
	...
	***************************************************************/
       ...
       'measure'=>$measure = $this->post('measure')
        ...
        if(isset($user_id) && isset($element) && isset($definition) && isset($measure) && isset($results) && isset($milestones_data) && isset($risk) && isset($teammembers) && isset($performance_elements) && isset($focusareaname) && isset($focusareaowner) ){
            ...
            if($token_status == TRUE){
                ...
                $Insert_saveQuestion_Result = $this->ActionOperation_modal->insertActionCall($update_id,$victory_data,$risk_data,$results_data,$measure_data,$milestones_data);
                if($Insert_saveQuestion_Result > 0){
    ...
    {
     //    $user_id = $this->post('user_id');
        // $result = $this->auth_model->getUserName($user_id);
        $valid = ['status' => "true","statuscode" => 200,'response' =>"Token Valid"];
        $no_found = ['status' => "true","statuscode" => 200,'response' =>"No Record Found"];
        $invalid = ['status' => "true","statuscode" => 203,'response' =>"In-Valid token"];
        $not_found = ['status' => "true","statuscode" => 404,'response' =>"Token not found"];
        ...
        if(isset($user_id) && isset($id)){
            ...
            if($token_status == TRUE){
                ...
                $Insert_saveQuestion_Result = $this->ActionOperation_modal->getUserName($id);
    ...
    {
            // $id = $this->post('id');
            // $Result = $this->ActionOperation_modal->performance_elements($id);
        $valid = ['status' => "true","statuscode" => 200,'response' =>"Token Valid"];
        $no_found = ['status' => "true","statuscode" => 200,'response' =>"No Record Found"];
        $invalid = ['status' => "true","statuscode" => 203,'response' =>"In-Valid token"];
        $not_found = ['status' => "true","statuscode" => 404,'response' =>"Token not found"];
        ...
        if(isset($user_id) && isset($id)){
            ...
            if($token_status == TRUE){
                ...
                $Insert_saveQuestion_Result = $this->ActionOperation_modal->performance_elements($id);
                if(!empty($Insert_saveQuestion_Result)){
    ...
    {
            // $id = $this->post('id');
            // $Result = $this->auth_model->performance_elements($id);
        $valid = ['status' => "true","statuscode" => 200,'response' =>"Token Valid"];
        $no_found = ['status' => "true","statuscode" => 200,'response' =>"No Record Found"];
        $invalid = ['status' => "true","statuscode" => 203,'response' =>"In-Valid token"];
        $not_found = ['status' => "true","statuscode" => 404,'response' =>"Token not found"];
