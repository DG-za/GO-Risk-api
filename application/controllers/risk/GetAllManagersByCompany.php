...
class GetAllManagersByCompany extends REST_Controller {
  /***************************************************************
  ...
  ***************************************************************/
  ...
  public function index_post(){
    ...
    $message = 'Required field(s) user_id,company is missing or empty';
    $user_id = $this->post('user_id');
    $company = $this->post('company');
    if(isset($user_id) && !empty($user_id) && isset($company) && !empty($company)){
