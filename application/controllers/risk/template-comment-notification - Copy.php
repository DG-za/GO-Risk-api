                        ...
                        <table width='100%' border='0' cellspacing='0' cellpadding='0'>
                            <tr>
                                  <td class='padding' align='center'>
                                    <a href='http://www.dashboard.co.za' target='_blank'><img src='http://www.digitalshepherd.co.za/img/mail.svg' width='338' border='0' alt='Make Contact' style='display: block; padding: 0; color: #666666; text-decoration: none; font-family: Helvetica, arial, sans-serif; font-size: 16px;' class='img-max'></a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    ...
                                    <table width='100%' border='0' cellspacing='0' cellpadding='0'>
                                        <tr>
                                            <td align='center' style='font-size: 25px; font-family: Helvetica, Arial, sans-serif; color: #FFF; padding-top: 30px;' class='padding'>Hi ".$user.", a task has been logged for your attention.</td>
                                        </tr>
                                        <tr>
                                            <td align='center' style='padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #545e67;' class='padding'> Please login to your dashboard to view the request.</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
