...
class GetRiskByCompanyCategory extends REST_Controller {
  /***************************************************************
  ...
  ***************************************************************/
  ...
  public function index_post(){
    ...
    $cat = $this->post('cat');
    if(isset($user_id) && !empty($user_id) && isset($company) && !empty($cat) && isset($company) && !empty($cat)){
      ...
      if($token_status == TRUE){
        ...
        if(!empty($results)){
          foreach ($results as $key => $value) {
            ...
            $merge_Array[$key]["risk_desc"] = $value->risk_desc;
          }
        }
