...
class SavePreventativeControl extends REST_Controller
{
	...
	public function index_post()
	{
		...
		$message = 'Required field(s) user_id, name, category_id or control_type is missing or empty';
		$user_id = $this->post('user_id');
		$name = $this->post('name');
		$category = $this->post('category_id');
		$type = $this->post('control_type');
		if (isset($user_id) && isset($name) && isset($category) && isset($type)) {
