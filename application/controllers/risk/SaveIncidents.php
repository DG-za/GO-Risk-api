...
class SaveIncidents extends REST_Controller {
  /***************************************************************
  ...
  ***************************************************************/
  ...
  public function index_post(){
    ...
    if(isset($user_id) && !empty($user_id) && isset($risk) && !empty($risk) && isset($cat) && !empty($cat) && isset($company) && !empty($company) && isset($type) && !empty($type) && isset($desc) && !empty($desc) && isset($controls) && !empty($controls)){
