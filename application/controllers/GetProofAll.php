...
class GetProofAll extends REST_Controller {
	...
	***************************************************************/
	...
	public function __construct() {
		...
		$this->load->model('GetProofAll_modal');
	}
	...
	public function index_post(){
		...
		if(isset($user_id)){
			...
			if($token_status == TRUE){
				$All_Elements = $this->GetProofAll_modal->Get_All_Elements_Function();
				$Pass_Data = array();				
				if(!empty($All_Elements)){
					foreach($All_Elements as $key => $value){
						...
						$All_Proofs_By_Element = $this->GetProofAll_modal->Get_Structured_Proof_By_Element($id);
						
						$Total_Proofs_By_Element = $this->GetProofAll_modal->Get_Proofs_Questions_By_Element($id);
