                ...
                <tr>
                    <td align='center' valign='top' style='padding: 15px 0;' class='logo'>
                        <a href='http://www.dashboard.co.za' target='_blank'>
                            <img alt='Logo' src='http://localhost/angular/api/img/logo-color.svg' width='170' style='display: block; font-family: Helvetica, Arial, sans-serif; color: #ffffff; font-size: 16px;' border='0'>
                        </a>
                    </td>
                </tr>
            </table>
                        ...
                        <table width='100%' border='0' cellspacing='0' cellpadding='0'>
                            <tr>
                                  <td class='padding' align='center'>
                                    <a href='http://www.dashboard.co.za' target='_blank'><img src='http://localhost/angular/api/img/task-complete.svg' width='310' border='0' alt='Make Contact' style='display: block; padding: 0; color: #666666; text-decoration: none; font-family: Helvetica, arial, sans-serif; font-size: 16px;' class='img-max'></a>
                                </td>
                            </tr>
                            <tr>
                                <td>
